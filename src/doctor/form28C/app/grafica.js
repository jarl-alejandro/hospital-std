...
graphicForm28C.controller('graphicForm28Ctrl', function ($scope, $http) {
  ...
  function renderGraphic (sexo) {
    ...
    if (sexo === 'Hombre') {
      $('.GraficaPeso img').attr('src', 'assets/img/graficas/niños-2meses_5años/peso.png')
      $('.GraficaLongitud img').attr('src', 'assets/img/graficas/niños-2meses_5años/peso.png')
      $('.GraficaCefalico img').attr('src', 'assets/img/graficas/niños-2meses_5años/peso.png')
      $('.GraficaIMC img').attr('src', 'assets/img/graficas/niños-2meses_5años/peso.png')
      ...
      $('.GraficaPeso img').attr('src', 'assets/img/graficas/niñas-2mese_5años/peso.png')
      $('.GraficaLongitud img').attr('src', 'assets/img/graficas/niñas-2mese_5años/peso.png')
      $('.GraficaCefalico img').attr('src', 'assets/img/graficas/niñas-2mese_5años/peso.png')
      $('.GraficaIMC img').attr('src', 'assets/img/graficas/niñas-2mese_5años/peso.png')
