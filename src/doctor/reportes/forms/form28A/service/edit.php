...
$new = $pdo->prepare("UPDATE hgc_form28 SET hgc_moti_form28=?, hgc_enfer_form28=?, hgc_paci_form28=?,
  hgc_turno_form28=?, hgc_fech_form28=?, hgc_hora_form28=? WHERE hgc_codi_form28='$codigo'");

$new->bindParam(1, $motivo);
$new->bindParam(2, $enfermedad);
$new->bindParam(3, $paciente);
$new->bindParam(4, $turno);
$new->bindParam(5, $hoy);
$new->bindParam(6, $hora);
$new->bindParam(7, $codigo);

$new->execute();

// OBSTRETICOS
$pdo->query("DELETE FROM hgc_obst WHERE hgc_form_obst='$codigo'");
...
// RECIEN NACIDOS
$pdo->query("DELETE FROM hgc_recien_nacido WHERE hgc_form_nac='$codigo'");
...
// ATENDIDO
$pdo->query("DELETE FROM hgc_atendido WHERE hgc_form_aten='$codigo'");
