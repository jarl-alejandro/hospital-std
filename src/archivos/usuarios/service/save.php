...
if ($id == "") {
  $new = $pdo->prepare("INSERT INTO hgc_profesionales (hgc_cedu_profe, hgc_nom_profe, hgc_ape_profe, hgc_celu_profe, hgc_tele_profe, hgc_direc_profe, hgc_dni_profe, hgc_emai_profe, hgc_fecn_profe, hgc_profe_profe, hgc_sexo_profe, hgc_rol_profe) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
