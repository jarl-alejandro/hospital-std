...
etnias.controller('etniasController', function ($scope, toaster, $http) {
	...
	$http.get('src/etnias/service/getAll.php')
	...
	$scope.handleSave = function (e) {
		...
		$http.post("src/etnias/service/save.php", { 'etnia': $scope.data.etnia, 'id': $scope.data.id })
      .then(response => {
	...
	$scope.delete = function (id) {
		$http.post("src/etnias/service/delete.php", { id })
      .then(response => {
      	if (response.data == 201) {
