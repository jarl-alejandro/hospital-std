...
hospital.config(($stateProvider, $urlRouterProvider) => {
  ...
  $stateProvider
    ...
    .state('form056Reporte', {
      ...
      controller: 'formReporteCtrl056',
      templateUrl: 'src/doctor/reportes/forms/form056/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('formAdultoMayorReporte', {
      url: '/reporte/adulto-mayor/:id/:turno',
      controller: 'adultoMayorReporteCtrl',
      templateUrl: 'src/doctor/reportes/forms/adulto-mayor/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('formAdultoMayor65Reporte', {
      url: '/reporte/adulto-mayor-65/:id/:turno',
      controller: 'adultoMayor65ReporteCtrl',
      templateUrl: 'src/doctor/reportes/forms/adulto-mayor-65/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('hojasDevolucionReporte', {
      url: '/reporte/hojadev/:id/:turno',
      controller: 'hojadevReporteController',
      templateUrl: 'src/doctor/reportes/forms/hoja-devolucion/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('adultoMayor', {
      url: '/adulto-mayor/:id/:turno/:action',
      controller: 'adultoMayorCtrl',
    ...
    .state('receta', {
      ...
      templateUrl: 'src/doctor/receta/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('solicitud', {
      url: '/solicitud',
      controller: 'SolicitudCtrl',
      templateUrl: 'src/doctor/solicitud/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('solicitudAdmision', {
      url: '/solicitud-admision',
      controller: 'solicitudAdminisionCtrl',
      templateUrl: 'src/estadistico/solicitud/index.html',
      resolve: { authenticated: auth_roles }
    })
    .state('recetaAdmision', {
      url: '/receta-admision',
      controller: 'RecetaAdmisionCtrl',
